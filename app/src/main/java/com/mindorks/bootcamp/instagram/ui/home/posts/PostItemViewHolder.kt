...
class PostItemViewHolder(parent: ViewGroup)
    : BaseItemViewHolder<Post,PostItemViewModel>(R.layout.layout_item_post,parent){
        ...
        viewModel.postImageDetail.observe(this, Observer {
            it?.run {
                ...
                if (placeholderWidth > 0 && placeholderHeight > 0) {
                    ...
                    params.width = placeholderWidth
                    params.height = placeholderHeight
                    // making image view set the proper params
                    itemView.ivPost.layoutParams = params

                    // making the incoming image of given params
                    glideRequest
                        .apply(RequestOptions.overrideOf(placeholderWidth, placeholderHeight))
